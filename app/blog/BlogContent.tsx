...
function PostCard({ post }: { post: Post }) {
  ...
  return (
    <Link
      href={`/${post.slug}`}
      className="card-hover group relative flex flex-col rounded-2xl overflow-hidden transition-all duration-300"
...
function FeaturedPost({ post }: { post: Post }) {
  ...
  return (
    <Link
      href={`/${post.slug}`}
      className="card-hover group grid grid-cols-1 lg:grid-cols-5 rounded-2xl overflow-hidden transition-all duration-300"
