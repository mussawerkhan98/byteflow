    ...
    <article>
      <section className="pt-20 pb-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-[var(--text-primary)] text-3xl sm:text-4xl font-bold leading-tight mb-4">
            {project.title}
          </h1>
          <p className="text-[var(--text-muted)] text-sm font-semibold mb-10">
            {project.client}
          </p>
          <div
          ...
          {project.deliverables.length > 0 && (
            <>
              <h2 className="text-[var(--text-primary)] text-lg font-bold mb-4">
                What we delivered
              </h2>
          ...
          {project.metrics.length > 0 && (
            <div
              ...
              style={{
                borderTop: "1px solid var(--overlay-hover)",
            ...
            >
              {project.metrics.map((m) => (
                <div key={m.label} className="flex flex-col">
                  ...
                  <span className="text-[var(--text-muted)] text-xs leading-snug">
                    {m.label}
                  </span>
                </div>
              ))}
          ...
          >
            ...
            <div>
              ...
              <p className="text-[var(--text-muted)] text-sm max-w-sm">
                Tell us what you&apos;re working with. Our team responds within
                2 hours.
              </p>
            </div>
            <a
