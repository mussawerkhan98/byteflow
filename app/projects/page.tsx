...
function ImagePlaceholder({
  ...
  return (
    ...
    >
      {/* Image element — hidden until src loads */}
      <img
        src={src}
        alt={alt}
      ...
      <svg
        ...
        stroke="currentColor"
        strokeWidth={1}
        style={{ color: 'rgba(44,205,222,0.25)' }}
      >
        <path
          strokeLinecap="round"
      ...
      <span className="relative z-10 text-[10px] font-medium tracking-wide" style={{ color: 'rgba(44,205,222,0.2)' }}>
        {alt}
      </span>
    </div>
  )
    ...
    return (
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(44,205,222,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(44,205,222,0.06) 1px, transparent 1px)',
            backgroundSize: '28px 28px',
          }}
        />
        {([[22, 24, 28], [57, 17, 18], [42, 55, 22], [73, 62, 13], [31, 73, 11]] as [number, number, number][]).map(
          ([x, y, s], i) => (
            <div
              key={i}
              ...
              style={{
                ...
                width: s,
                height: s,
                background: 'rgba(44,205,222,0.11)',
                border: '1px solid rgba(44,205,222,0.38)',
        ...
        <div className="absolute bottom-3 left-4">
          <span className="text-[9px] font-mono tracking-[0.2em]" style={{ color: 'rgba(44,205,222,0.28)' }}>
            IT / NETWORK
          </span>
        </div>
      </div>
    ...
    return (
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              'repeating-linear-gradient(60deg, rgba(44,205,222,0.04) 0, rgba(44,205,222,0.04) 1px, transparent 1px, transparent 26px)',
        ...
        <div className="absolute top-1/2 left-[38%] -translate-x-1/2 -translate-y-1/2 opacity-[0.14]">
          <svg width="68" height="80" viewBox="0 0 68 80" fill="none">
            <path
              d="M34 3L5 14v22c0 17.5 12 32.5 29 37 17-4.5 29-19.5 29-37V14L34 3z"
              fill="rgba(44,205,222,0.5)"
              stroke="rgba(44,205,222,0.8)"
              strokeWidth="1.5"
            />
          </svg>
        </div>
    ...
    return (
      ...
      >
        {([
          ...
          [54, 72, 35],
          [62, 42, 65],
        ] as [number, number, number][]).map(([top, left, width], i) => (
          <div
            key={i}
            ...
            style={{
              ...
              left: `${left * 0.14}%`,
              width: `${width * 0.55}%`,
              background: `rgba(70,163,225,${0.1 + (i % 3) * 0.05})`,
            }}
          />
        ))}
        <div
          className="absolute top-4 left-4 w-2 h-2 rounded-full"
          style={{ background: '#2CCDDE', opacity: 0.5 }}
        />
        <div
          className="absolute top-4 left-8 w-2 h-2 rounded-full"
          style={{ background: '#46A3E1', opacity: 0.4 }}
        />
        <div className="absolute bottom-3 left-4">
          <span className="text-[9px] font-mono tracking-[0.2em]" style={{ color: 'rgba(70,163,225,0.28)' }}>
            WEB / DEV
          </span>
        </div>
      </div>
      ...
      >
        <div className="absolute top-1/2 left-[38%] -translate-x-1/2 -translate-y-[60%] opacity-[0.12]">
          <svg width="100" height="68" viewBox="0 0 100 68" fill="none">
            <path
              d="M75 44H22A18 18 0 1122 8a18 18 0 0133-4 22 22 0 1120 40z"
              fill="rgba(44,205,222,0.5)"
            />
          </svg>
        </div>
        {[0, 1, 2].map((i) => (
          <div
            ...
            style={{
              ...
              left: `${36 + i * 14}%`,
              height: '28%',
              background: 'linear-gradient(0deg, rgba(44,205,222,0.35), transparent)',
            }}
          />
        ))}
        <div className="absolute bottom-3 left-4">
    ...
    return (
      ...
      >
        {([36, 52, 42, 68, 50, 78, 64] as number[]).map((h, i) => (
          <div
            key={i}
            className="absolute bottom-10 rounded-t"
            style={{
              left: `${11 + i * 11.5}%`,
              width: '7%',
              height: `${h * 0.55}%`,
              background: `rgba(44,205,222,${0.1 + i * 0.04})`,
        ...
        {([
          ...
          <div
            ...
            style={{
              left: `${x}%`,
              top: `${y}%`,
              background: 'rgba(44,205,222,0.45)',
              transform: 'translate(-50%,-50%)',
            }}
          />
        ))}
      ...
      {([80, 60, 42, 24] as number[]).map((size, i) => (
        <div
          ...
          style={{
            ...
            left: '35%',
            transform: 'translate(-50%,-50%)',
            border: `1px solid rgba(44,205,222,${0.08 + i * 0.07})`,
          }}
        />
      ))}
      {(['#2CCDDE', '#46A3E1', 'rgba(44,205,222,0.4)', 'rgba(70,163,225,0.3)'] as string[]).map((c, i) => (
        <div
          key={i}
          className="absolute w-6 h-6 rounded"
          style={{ right: `${10 + i * 19}%`, top: '28%', background: c, opacity: 0.35 }}
        />
      ))}
      <div className="absolute bottom-3 left-4">
        <span className="text-[9px] font-mono tracking-[0.2em]" style={{ color: 'rgba(70,163,225,0.28)' }}>
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5">
        ...
        <div className="lg:col-span-2 p-5">
          <ImagePlaceholder src={project.image} alt={project.client} className="h-56 lg:h-full min-h-[280px]" />
        </div>
        ...
        <div className="lg:col-span-3 p-7 flex flex-col justify-between gap-6">
          <div>
            ...
            <div className="flex items-center gap-3 mb-5">
              <span className="text-[9px] font-bold tracking-[0.18em] uppercase" style={{ color: '#2CCDDE' }}>
                {project.category}
              </span>
  ...
  return (
    ...
    >
      ...
      <div className="p-4 pb-0">
        <ImagePlaceholder src={project.image} alt={project.client} className="h-44" />
      </div>
