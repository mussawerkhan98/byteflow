      ...
      <section className="pt-20 pb-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div
            ...
            style={{ background: gradient, border: '1px solid rgba(44,205,222,0.18)' }}
          >
            {post.image_url ? (
              <Image src={post.image_url} alt={post.title} fill sizes="(min-width: 768px) 768px, 100vw" priority className="object-cover" />
            ) : (
              <div
