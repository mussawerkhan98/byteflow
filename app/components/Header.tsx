    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-[76px] gap-8">
          ...
          <Link
            href="/contact-us"
            className="group inline-flex items-center gap-2 text-black text-sm font-bold px-5 py-2.5 rounded-full flex-shrink-0 transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_28px_rgba(44,205,222,0.45)]"
